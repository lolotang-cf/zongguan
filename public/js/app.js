...
/* ============================================================
   ...
   successMsg 三种语义：
     1) 字符串(且非全局函数名) -> 提交后 alert('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> '+msg) 并关闭
...
window.showFormModal = function(title, fields, submitText, successMsg) {
  ...
  var actions = '<div class="detail-actions" style="margin-top:18px">'
    ...
    + 'else{closeDetailModal();alert(\'<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> ' + (successMsg || '操作成功') + '\')}">'
...
window.mockSuccess = function(msg) { alert('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> ' + msg); };
...
window.modalCb_createRole = function(v) {
  ...
  alert('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> 角色「' + name + '」已创建');
  return true;
};
window.modalCb_editPerson = function(v) {
  var name = v.personName || '人员';
  alert('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> ' + name + ' 信息已更新');
  return true;
};
window.modalCb_editProject = function(v) {
  var name = v.projName || '项目';
  alert('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> 项目「' + name + '」信息已更新');
  return true;
};
window.modalCb_saveRolePerm = function() {
  alert('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> 角色权限已保存');
  return true;
};
window.modalCb_rejectPerm = function(v) {
  if (!v || !v.rejReason) { alert('请填写驳回理由'); return false; }
  alert('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> 权限申请已驳回');
  return true;
};
...
window.showWorkplaceDetail = function(d) {
  ...
  showDetailModal('职场详情 - ' + d.id,
    ...
    + '<div class="detail-actions"><button class="btn btn-primary" onclick="closeDetailModal()"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-pen-tool\"></use></svg> 编辑</button>'
    + '<button class="btn btn-outline" onclick="closeDetailModal()"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-clipboard-list\"></use></svg> 导出</button>'
...
window.showAssetDetail = function(a) {
  showDetailModal('资产详情 - ' + a.id,
    ...
    + '</div></div>'
    + '<div class="detail-actions"><button class="btn btn-primary" onclick="closeDetailModal();showAssetTransfer({id:\'' + a.id + '\',name:\'' + a.name + '\',center:\'' + (a.center||'') + '\'})"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-refresh-cw\"></use></svg> 申请转出</button>'
    + '<button class="btn btn-outline" onclick="closeDetailModal()"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-user\"></use></svg> 变更使用人</button>'
    + '<button class="btn btn-outline" onclick="closeDetailModal()" style="margin-left:auto">关闭</button></div>'
  );
};
...
window.showAssetTransfer = function(asset) {
  ...
  showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-refresh-cw\"></use></svg> 固资转出' + (assetName ? ' - ' + assetName : ''),
    ...
    + '<button class="btn btn-primary" style="flex:1;padding:10px" onclick="var tc=document.getElementById(\'transferTargetCenter\').value;var tr=document.getElementById(\'transferReceiver\').value;var reason=document.getElementById(\'transferReason\').value;if(!tc){alert(\'请选择目标中心\');return}if(!tr){alert(\'请填写接收人\');return}if(!reason){alert(\'请选择转出原因\');return}closeDetailModal();alert(\'<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> 固资转出申请已提交\\n\\n资产：' + assetName + '\\n目标中心：\' + tc + \'\\n接收人：\' + tr + \'\\n原因：\' + reason + \'\\n\\n等待双方负责人审批\')">提交转出申请</button>'
...
window.showSupplyRequisitionDetail = function(i) {
  showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-upload\"></use></svg> 领用 - ' + i.name,
    '<div style="padding:20px">'
    ...
    + '<button class="btn btn-primary" style="width:100%" onclick="closeDetailModal();alert(\'<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> 领用申请已提交\\n\\n物品：' + i.name + '\\n数量：\' + document.getElementById(\'reqQty_' + i.id + '\').value + \' ' + (i.unit||'') + '\')">提交申请</button></div>'
  );
};

// 办公用品-出库详情弹窗（表格行调用）
window.showSupplyOutboundDetail = function(i) {
  showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-package\"></use></svg> 出库 - ' + i.name,
    '<div style="padding:20px">'
    + '<div style="margin-bottom:14px"><label style="display:block;font-size:13px;color:#666;margin-bottom:4px">物品名称</label>'
    + '<input type="text" value="' + i.name + '" readonly style="width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box;background:#f5f5f5;color:#999"></div>'
    + '<div style="margin-bottom:14px"><label style="display:block;font-size:13px;color:#666;margin-bottom:4px">当前库存</label>'
    ...
    + '<button class="btn btn-primary" style="width:100%" onclick="closeDetailModal();alert(\'<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-check-circle-2\"></use></svg> 出库登记已确认\\n\\n物品：' + i.name + '\\n数量：\' + document.getElementById(\'outQty_' + i.id + '\').value + \' ' + (i.unit||'') + '\')">确认出库</button></div>'
  );
};
...
window.showCaseDetail = function(r) {
  showDetailModal('劳动案件 - ' + r.id,
    ...
    + '</div></div>'
    + '<div class="detail-actions"><button class="btn btn-primary" onclick="closeDetailModal()"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-file-edit\"></use></svg> 更新进度</button>'
    + '<button class="btn btn-outline" onclick="closeDetailModal()"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-file-text\"></use></svg> 导出卷宗</button>'
    + '<button class="btn btn-outline" onclick="closeDetailModal()" style="margin-left:auto">关闭</button></div>'
  );
};
...
window.showKpiDetail = function(kpi) {
  ...
  showDetailModal('KPI 详情 - ' + kpi.name,
    ...
    + '</div>'
    + '<div class="detail-actions"><button class="btn btn-primary" onclick="closeDetailModal()"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-file-edit\"></use></svg> 修改评分</button>'
    + '<button class="btn btn-outline" onclick="closeDetailModal()"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-message-circle\"></use></svg> 绩效面谈</button>'
    + '<button class="btn btn-outline" onclick="closeDetailModal()" style="margin-left:auto">关闭</button></div>'
  );
};
...
window.showStaffingDetail = function(s) {
  showDetailModal('编制详情 - ' + s.dept,
    ...
    + '</div>'
    + '<div class="detail-actions"><button class="btn btn-primary" onclick="closeDetailModal()"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-pen-tool\"></use></svg> 调整编制</button>'
    + '<button class="btn btn-outline" onclick="closeDetailModal()"><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-clipboard-list\"></use></svg> 导出</button>'
    + '<button class="btn btn-outline" onclick="closeDetailModal()" style="margin-left:auto">关闭</button></div>'
  );
      ...
      ${lightData.map(l => {
        ...
        return `<div class="kpi-card" style="border-top:3px solid ${st.color}">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
            ...
            <span style="font-size:22px">${st.emoji}</span>
          </div>
    ...
    <div class="chart-card" style="margin-top:8px">
      ...
      <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:12px;margin-top:8px">
        <div style="text-align:center;padding:12px;background:var(--bg);border-radius:8px">
          <div style="font-size:20px;margin-bottom:6px"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-target"></use></svg></div>
        ...
        <div style="text-align:center;padding:12px;background:var(--bg);border-radius:8px">
          <div style="font-size:20px;margin-bottom:6px"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-graduation-cap"></use></svg></div>
          <div style="font-size:13px;font-weight:600;color:var(--primary)">培训管理</div>
          <div style="font-size:11px;color:var(--success);margin-top:4px">● 已同步</div>
          <div style="font-size:11px;color:var(--text-light);margin-top:2px">${syncTime}</div>
        </div>
        <div style="text-align:center;padding:12px;background:var(--bg);border-radius:8px">
          <div style="font-size:20px;margin-bottom:6px"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-users"></use></svg></div>
          <div style="font-size:13px;font-weight:600;color:var(--primary)">人事管理</div>
          <div style="font-size:11px;color:var(--success);margin-top:4px">● 已同步</div>
          <div style="font-size:11px;color:var(--text-light);margin-top:2px">${syncTime}</div>
        </div>
        <div style="text-align:center;padding:12px;background:var(--bg);border-radius:8px">
          <div style="font-size:20px;margin-bottom:6px"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-package"></use></svg></div>
          <div style="font-size:13px;font-weight:600;color:var(--primary)">行政管理</div>
          <div style="font-size:11px;color:var(--success);margin-top:4px">● 已同步</div>
          <div style="font-size:11px;color:var(--text-light);margin-top:2px">${syncTime}</div>
        </div>
        <div style="text-align:center;padding:12px;background:var(--bg);border-radius:8px">
          <div style="font-size:20px;margin-bottom:6px"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-megaphone"></use></svg></div>
...
async function loadSysPermission() {
  ...
  renderPage(`
    ...
    <div class="row cols-2">
      <div class="chart-card">
        <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-users"></use></svg> 角色权限矩阵 <button class="btn btn-primary" style="float:right;padding:4px 12px;font-size:12px" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 新建角色\',[{\'name\':\'roleName\',\'label\':\'角色名称\',\'required\':true,\'placeholder\':\'如：中心管理员\'},{\'name\':\'roleDesc\',\'label\':\'角色描述\',\'type\':\'textarea\',\'rows\':2,\'placeholder\':\'简要描述该角色职责\'},{\'name\':\'roleScope\',\'label\':\'数据范围\',\'type\':\'select\',\'options\':[\'全部中心\',\'本中心\',\'自定义\'],\'value\':\'本中心\'}],\'创建角色\',\'modalCb_createRole\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 新建角色</button></div>
...
async function loadTrainTalent() {
  ...
  renderPage(`
    <div class="filter-bar">
      ...
      <button class="btn btn-primary" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-search"></use></svg> 人才库查询\',[{\'name\':\'talentDate\',\'label\':\'统计日期\',\'type\':\'date\'},{\'name\':\'talentKeyword\',\'label\':\'关键词\',\'placeholder\':\'姓名 / 工号 / 中心\'}],\'查询\',\'人才库查询条件已应用\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-search"></use></svg> 查询</button>
      <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导入人才库\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>请选择要导入的 Excel 文件，系统将自动解析并更新人才库数据。</p>\',\'选择文件并导入\',\'人才库数据导入中\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导入Excel</button>
      <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 导出人才库\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>当前筛选范围内的人才数据将导出为 Excel。</p>\',\'确认导出\',\'人才库已导出Excel\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 导出Excel</button>
      <button class="btn btn-outline" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-calendar"></use></svg> 历史快照\',[{\'name\':\'snapDate\',\'label\':\'选择快照日期\',\'type\':\'select\',\'options\':[{\'value\':\'2026-06-30\',\'text\':\'2026-06-30（月末快照）\'},{\'value\':\'2026-05-31\',\'text\':\'2026-05-31（月末快照）\'},{\'value\':\'2026-04-30\',\'text\':\'2026-04-30（月末快照）\'}]}],\'查看快照\',\'已加载历史快照\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-calendar"></use></svg> 历史快照</button>
...
async function loadTrainNew() {
  ...
  renderPage(`
    <div class="filter-bar">
      ...
      <button class="btn btn-primary" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-search"></use></svg> 新培库查询\',[{\'name\':\'trainDate\',\'label\':\'统计日期\',\'type\':\'date\'},{\'name\':\'trainKeyword\',\'label\':\'关键词\',\'placeholder\':\'项目 / 中心\'}],\'查询\',\'新培库查询条件已应用\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-search"></use></svg> 查询</button>
      <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导入新培库\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>请选择要导入的 Excel 文件，系统将自动解析并更新新培库数据。</p>\',\'选择文件并导入\',\'新培库数据导入中\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导入Excel</button>
      <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 导出新培库\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>当前筛选范围内的新培项目将导出为 Excel。</p>\',\'确认导出\',\'新培库已导出Excel\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 导出Excel</button>
      <button class="btn btn-outline" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-calendar"></use></svg> 历史快照\',[{\'name\':\'snapDate\',\'label\':\'选择快照日期\',\'type\':\'select\',\'options\':[{\'value\':\'2026-06-30\',\'text\':\'2026-06-30（月末快照）\'},{\'value\':\'2026-05-31\',\'text\':\'2026-05-31（月末快照）\'},{\'value\':\'2026-04-30\',\'text\':\'2026-04-30（月末快照）\'}]}],\'查看快照\',\'已加载历史快照\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-calendar"></use></svg> 历史快照</button>
      <span style="margin-left:auto;font-size:12px;color:var(--text-light)">数据实时同步 | 各中心可在线编辑</span>
      <span style="font-size:12px;padding:2px 10px;background:${COLORS.blue}20;color:${COLORS.blue};border-radius:4px;font-weight:600">当前权限：总部-全部中心</span>
    </div>
  ...
  function renderKnowledgePage() {
    renderPage(`
      ...
      <div class="sub-tabs" id="kbTabs">
        <button class="sub-tab ${kbCurrentTab==='catalog'?'active':''}" onclick="switchKbTab('catalog')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-book-opened"></use></svg> 课程目录</button>
        <button class="sub-tab ${kbCurrentTab==='paths'?'active':''}" onclick="switchKbTab('paths')">🛤️ 学习路径</button>
        <button class="sub-tab ${kbCurrentTab==='stats'?'active':''}" onclick="switchKbTab('stats')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-bar-chart-2"></use></svg> 学习统计</button>
        <button class="sub-tab ${kbCurrentTab==='tags'?'active':''}" onclick="switchKbTab('tags')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-tag"></use></svg>️ 知识标签</button>
    ...
    return `
      <div style="display:flex;gap:16px">
        ...
        <div class="kb-sidebar">
          ...
          <div class="kb-cat-item ${!kbCurrentCategory?'active':''}" onclick="filterByCategory('')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 全部课程 (${kbData.courses.length})</div>
        ...
        <div style="flex:1;min-width:0">
          <div class="filter-bar">
            ...
            <button class="btn btn-primary" onclick="onKbSearch(document.getElementById('kbSearchInput').value)"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-search"></use></svg> 搜索</button>
            ...
            <button class="btn btn-outline" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 上传课件\',[{\'name\':\'courseName\',\'label\':\'课件名称\',\'required\':true},{\'name\':\'courseType\',\'label\':\'类型\',\'type\':\'select\',\'options\':[\'PPT\',\'PDF\',\'视频\',\'Word\'],\'value\':\'PPT\'},{\'name\':\'courseSize\',\'label\':\'文件大小(MB)\',\'type\':\'number\'}],\'开始上传\',\'课件上传中\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 上传课件</button>
          </div>
            ...
            ${list.map(k => `
              <tr>
                ...
                <td>
                  ...
                  <button class="btn btn-outline" style="padding:3px 10px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-arrow-down"></use></svg>️ 下载文档 - \' + rowCellText(this,1),\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>开始下载文档。</p>\',\'开始下载\',\'文档开始下载\')">下载</button>
                </td>
              </tr>
            `).join('')}
          </tbody>
        ...
        ${kbData.learningPaths.map((p,i) => `
          <div class="kb-path-card">
            ...
            <div class="kb-path-body">
              ...
              <button class="btn btn-primary kb-path-btn" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-library"></use></svg> 学习路径 - \' + rowCellText(this,1),\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>将按课程顺序开启学习路径。</p>\',\'开始学习\',\'已开启学习路径\')">开始学习 →</button>
            </div>
          </div>
        `).join('')}
      </div>
  ...
  window.openCourseDetail = function(courseId) {
    ...
    document.getElementById('kbModalBody').innerHTML = `
      ...
      <div class="kb-detail-actions">
        ...
        <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-arrow-down"></use></svg>️ 下载文档 - \' + rowCellText(this,1),\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>开始下载文档。</p>\',\'开始下载\',\'文档开始下载\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-arrow-down"></use></svg>️ 下载课件</button>
        ...
        <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-link"></use></svg> 分享\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>分享链接已复制到剪贴板。</p>\',\'好的\',\'分享链接已复制\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-link"></use></svg> 分享</button>
      </div>
    `;
...
async function loadTrainExam() {
  ...
  renderPage(`
    ...
    <div id="teTab-exam" style="display:block">
      <div class="chart-card">
        <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-bar-chart-2"></use></svg> 考试列表 <div style="float:right;display:flex;gap:6px"><button class="btn btn-primary" style="padding:4px 12px;font-size:12px" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-file-edit"></use></svg> 创建考试\',[{\'name\':\'examName\',\'label\':\'考试名称\',\'required\':true},{\'name\':\'examTime\',\'label\':\'考试时间\'},{\'name\':\'examPeople\',\'label\':\'应考人员\'},{\'name\':\'examScope\',\'label\':\'题目范围\',\'type\':\'textarea\',\'rows\':2}],\'创建考试\',\'考试已创建\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 创建考试</button><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-bot"></use></svg> 自动组卷\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>按题型比例（单选40%/多选25%/判断25%/简答10%）自动组卷。</p>\',\'开始组卷\',\'已启动自动组卷\')">⚡ 自动组卷</button></div></div>
        <table class="data-table">
          <thead><tr><th>考试编号</th><th>考试名称</th><th>应考</th><th>已交</th><th>平均分</th><th>通过率</th><th>状态</th><th>操作</th></tr></thead>
          <tbody>
            ${data.exams.map(e => `<tr><td>${e.id}</td><td><strong>${e.name}</strong></td><td>${e.candidates}</td><td>${e.submitted}</td><td>${e.avgScore}</td><td><span class="tag ${e.passRate>=90?'tag-success':'tag-warning'}">${e.passRate}%</span></td><td><span class="tag ${e.status==='进行中'?'tag-info':'tag-gray'}">${e.status}</span></td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-file-edit"></use></svg> 考试详情 - \' + rowCellText(this,1),rowDetailHTML(this))">查看</button></td></tr>`).join('')}
          </tbody>
        </table>
      </div>
    </div>
    <div id="teTab-question" style="display:none">
      <div class="chart-card">
        <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 题库预览 <div style="float:right;display:flex;gap:6px"><button class="btn btn-primary" style="padding:4px 12px;font-size:12px" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 录入题目\',[{\'name\':\'qType\',\'label\':\'题型\',\'type\':\'select\',\'options\':[\'单选\',\'多选\',\'判断\',\'简答\'],\'value\':\'单选\'},{\'name\':\'qStem\',\'label\':\'题干\',\'type\':\'textarea\',\'required\':true,\'rows\':3},{\'name\':\'qAnswer\',\'label\':\'答案\',\'type\':\'textarea\',\'required\':true,\'rows\':2},{\'name\':\'qDiff\',\'label\':\'难度\',\'type\':\'select\',\'options\':[\'易\',\'中\',\'难\'],\'value\':\'中\'}],\'保存题目\',\'题目已录入\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 录入题目</button><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-arrow-down"></use></svg>️ 下载文档 - \' + rowCellText(this,1),\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>开始下载文档。</p>\',\'开始下载\',\'文档开始下载\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 批量导入</button></div></div>
        <table class="data-table">
  ...
  renderPage(`
    ...
    <div class="filter-bar" style="gap:0;border-bottom:2px solid var(--border);margin-bottom:16px">
      ...
      <div style="margin-left:auto;position:relative">
        <button class="btn btn-primary" style="padding:6px 16px;font-size:13px" onclick="var d=this.nextElementSibling;d.style.display=d.style.display==='block'?'none':'block'"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 发起流程 ▾</button>
      ...
      <table class="data-table">
        ...
        <tbody id="hrProcessBody">
          ${data.map(p => {
            ...
            return `<tr data-type="${p.type}"><td>${p.id}</td><td><span class="tag ${typeMap[p.type]}">${p.type}</span></td><td><strong>${p.applicant}</strong></td><td>${p.department || p.from + ' → ' + p.to}</td><td>${p.center}</td><td>${p.date}</td><td>${p.currentStep}</td><td><div style="display:flex;align-items:center;gap:8px"><div style="flex:1;height:8px;background:var(--border);border-radius:4px;overflow:hidden;min-width:80px"><div style="width:${prog}%;height:100%;background:${progColor};transition:width .3s"></div></div><span style="font-size:11px;color:var(--text-light);white-space:nowrap">${prog}%</span></div></td><td><span class="tag ${statusMap[p.status]}">${p.status}</span></td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 审批详情 - \' + rowCellText(this,0),rowDetailHTML(this))">详情</button></td></tr>`;
          }).join('')}
        </tbody>
      </table>
    </div>
...
async function loadHrContract() {
  ...
  renderPage(`
    ...
    <div class="chart-card">
      <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 合同到期分级预警 <div style="float:right;display:flex;gap:6px"><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-message-circle"></use></svg> 推送续签提醒\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>向员工推送企业微信续签提醒。</p>\',\'确认推送\',\'续签提醒已推送\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-message-circle"></use></svg> 推送提醒</button><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出预警清单\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>合同预警清单将导出为 Excel。</p>\',\'确认导出\',\'合同预警清单已导出\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button></div></div>
      <table class="data-table">
        ...
        <tbody>
          ${data.sort((a,b)=>a.daysLeft-b.daysLeft).map(c => {
            ...
            return `<tr><td>${c.id}</td><td><strong>${c.name}</strong></td><td>${c.department}</td><td>${c.center}</td><td>${c.type}</td><td>${c.startDate}</td><td>${c.endDate}</td><td><strong style="color:${c.daysLeft<=30?'var(--danger)':c.daysLeft<=60?'var(--warning)':'var(--text-light)'}">${c.daysLeft}天</strong></td><td><span class="tag ${level}">${levelText}</span></td><td><span class="tag tag-warning">${c.renewStatus||'待处理'}</span></td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-refresh-cw"></use></svg> 发起续签 - \' + rowCellText(this,0),[{\'name\':\'renewMonths\',\'label\':\'续签时长(月)\',\'type\':\'number\',\'value\':\'12\'},{\'name\':\'renewNote\',\'label\':\'备注\',\'type\':\'textarea\',\'rows\':2}],\'确认发起\',\'续签流程已发起\')">续签</button></td></tr>`;
          }).join('')}
        </tbody>
      </table>
    </div>
...
async function loadAdminSupplies() {
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <div class="filter-bar">
        <button class="btn btn-primary" onclick="showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-plus-circle\"></use></svg> 入库登记','<div style=&quot;padding:20px&quot;><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>物品名称 *</label><input type=&quot;text&quot; placeholder=&quot;请输入物品名称&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>分类</label><select style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;><option>办公文具</option><option>办公设备</option><option>清洁用品</option><option>其他</option></select></div><div style=&quot;display:flex;gap:10px&quot;><div style=&quot;flex:1;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>数量</label><input type=&quot;number&quot; min=&quot;1&quot; value=&quot;1&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;></div><div style=&quot;flex:1;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>单位</label><select style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;><option>包</option><option>盒</option><option>个</option><option>台</option></select></div></div><button class=&quot;btn btn-primary&quot; style=&quot;width:100%&quot; onclick=&quot;closeDetailModal();alert(\\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-check-circle-2"></use></svg> 入库登记已提交')确认入库</button></div>')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 入库</button>
        <button class="btn btn-outline" onclick="showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-upload\"></use></svg> 领用申请','<div style=&quot;padding:20px&quot;><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>物品名称 *</label><select id=&quot;reqItem&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;><option value=&quot;&quot;>-- 请选择 --</option><option>A4打印纸</option><option>中性笔(黑色)</option><option>文件夹(A4)</option><option>订书机</option><option>计算器</option><option>回形针</option><option>便利贴</option><option>档案盒</option></select></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>领用数量 *</label><input type=&quot;number&quot; id=&quot;reqQty&quot; min=&quot;1&quot; value=&quot;1&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>用途说明</label><textarea id=&quot;reqPurpose&quot; rows=&quot;2&quot; placeholder=&quot;请简要说明领用用途...&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box;resize:vertical&quot;></textarea></div><button class=&quot;btn btn-primary&quot; style=&quot;width:100%&quot; onclick=&quot;var item=document.getElementById(\\'reqItem\\').value;var qty=document.getElementById(\\'reqQty\\').value;if(!item){alert(\\'请选择物品名称\\');return}if(!qty||qty<1){alert(\\'请输入有效数量\\');return}closeDetailModal();alert(\\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-check-circle-2"></use></svg> 领用申请已提交\\n\\n物品：\\' + item + \\'\\n数量：\\' + qty)&quot;>提交申请</button></div>')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 领用</button>
        <button class="btn btn-outline" onclick="showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-package\"></use></svg> 出库登记','<div style=&quot;padding:20px&quot;><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>物品名称 *</label><select id=&quot;outItem&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;><option value=&quot;&quot;>-- 请选择 --</option><option>A4打印纸</option><option>中性笔(黑色)</option><option>文件夹(A4)</option><option>订书机</option><option>计算器</option><option>回形针</option><option>便利贴</option><option>档案盒</option></select></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>出库数量 *</label><input type=&quot;number&quot; id=&quot;outQty&quot; min=&quot;1&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>出库原因</label><select id=&quot;outReason&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;><option value=&quot;&quot;>-- 请选择 --</option><option value=&quot;领用发放&quot;>领用发放</option><option value=&quot;部门调拨&quot;>部门调拨</option><option value=&quot;损耗报废&quot;>损耗报废</option><option value=&quot;盘亏处理&quot;>盘亏处理</option><option value=&quot;其他&quot;>其他</option></select></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>接收人/部门</label><input type=&quot;text&quot; id=&quot;outReceiver&quot; placeholder=&quot;请输入接收人或部门&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;></div><button class=&quot;btn btn-primary&quot; style=&quot;width:100%&quot; onclick=&quot;var item=document.getElementById(\\'outItem\\').value;var qty=document.getElementById(\\'outQty\\').value;var reason=document.getElementById(\\'outReason\\').value;if(!item){alert(\\'请选择物品名称\\');return}if(!qty){alert(\\'请输入出库数量\\');return}closeDetailModal();alert(\\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-check-circle-2"></use></svg> 出库登记已确认\\n\\n物品：\\' + item + \\'\\n数量：\\' + qty + \\'\\n原因：\\' + reason)&quot;>确认出库</button></div>')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-package"></use></svg> 出库</button>
        <button class="btn btn-outline" onclick="showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-download\"></use></svg> 导出库存明细','<div style=&quot;padding:24px;text-align:center&quot;><div style=&quot;font-size:48px;margin-bottom:16px&quot;><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-download\"></use></svg></div><div style=&quot;font-size:16px;font-weight:600;margin-bottom:8px&quot;>导出库存明细</div><div style=&quot;font-size:13px;color:#888;margin-bottom:20px&quot;>当前共有 <strong>' + ${items.length} + '</strong> 种物品记录</div><button class=&quot;btn btn-primary&quot; style=&quot;width:200px&quot; onclick=&quot;closeDetailModal();alert(\\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-check-circle-2"></use></svg> 库存明细已导出为 Excel\\n\\n文件名：办公用品库存_20260720.xlsx')确认导出</button></div>')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button>
      </div>
      <table class="data-table">
...
async function loadPrOpinion() {
  ...
  function renderPrPlatformTable(items, name, itemLabel, m1, m2) {
    return '<table class="data-table"><thead><tr><th style="width:40px">#</th><th>' + itemLabel + '标题</th><th>作者</th><th>发布时间</th><th>' + m1 + '</th><th>' + m2 + '</th><th>情感</th><th>操作</th></tr></thead><tbody>' +
      items.map((it, i) => '<tr><td>' + (i+1) + '</td><td><strong>' + it.title + '</strong></td><td>' + it.author + '</td><td>' + it.time + '</td><td>' + (it.reads || it.views || it.reads) + '</td><td>' + (it.likes || it.comments || it.answers || it.likes) + '</td><td><span class="tag ' + (it.sentiment==='正面'?'tag-success':it.sentiment==='负面'?'tag-danger':'tag-warning') + '">' + it.sentiment + '</span></td><td><button class="btn btn-outline" style="padding:2px 10px;font-size:11px" onclick="showInfoModal(\'<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-newspaper\"></use></svg> 舆情原文 - \' + rowCellText(this,1),rowDetailHTML(this))">查看</button></td></tr>').join('') +
      '</tbody></table>';
  }
  ...
  renderPage(`
    ...
    ${data.alerts.length > 0 ? `<div class="chart-card"><div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-alert-triangle"></use></svg> 负面舆情预警</div>${data.alerts.map(a => `<div class="alert-item alert-${a.level==='高'?'danger':'warning'}"><span class="alert-icon">${a.level==='高'?'<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-alert-triangle\"></use></svg>':'<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-alert-circle\"></use></svg>'}</span><div><strong>[${a.level}]</strong> ${a.time} · ${a.source} — ${a.content}<br><span style="font-size:12px;color:var(--text-light)">状态: ${a.status} ${a.handler?'· 处理人: '+a.handler:''}</span> <button class="btn btn-outline" style="padding:2px 10px;font-size:11px;margin-left:8px" onclick="showFormModal(\'⚠ 处理舆情预警 - \' + rowCellText(this,0),[{\'name\':\'handleResult\',\'label\':\'处理结果\',\'type\':\'select\',\'options\':[\'属实-已处理\',\'属实-处理中\',\'不实-已澄清\'],\'value\':\'属实-处理中\'},{\'name\':\'handleNote\',\'label\':\'处理说明\',\'type\':\'textarea\',\'required\':true,\'rows\':3}],\'提交处理\',\'预警已处理\')">处理</button></div></div>`).join('')}</div>` : ''}
    <div class="row cols-2">
      <div class="chart-card">
    ...
    <div class="chart-card">
      ...
      <div class="filter-bar">
        <button class="btn btn-primary" onclick="switchPrTab('wechat')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-message-circle"></use></svg> 微信公众号</button>
        <button class="btn btn-outline" onclick="switchPrTab('weibo')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-megaphone"></use></svg> 微博</button>
        <button class="btn btn-outline" onclick="switchPrTab('douyin')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-music"></use></svg> 抖音</button>
        <button class="btn btn-outline" onclick="switchPrTab('xiaohongshu')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-book"></use></svg> 小红书</button>
        <button class="btn btn-outline" onclick="switchPrTab('zhihu')">❓ 知乎</button>
        <button class="btn btn-outline" onclick="switchPrTab('maimai')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-briefcase-alt"></use></svg> 脉脉</button>
      </div>
      <div id="prTabContent">
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <div class="filter-bar">
        ...
        <button class="btn btn-primary" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 新增编制\',[{\'name\':\'deptName\',\'label\':\'部门\',\'required\':true},{\'name\':\'postName\',\'label\':\'岗位\',\'required\':true},{\'name\':\'headcount\',\'label\':\'编制人数\',\'type\':\'number\',\'required\':true,\'value\':\'1\'},{\'name\':\'postType\',\'label\':\'岗位类别\',\'type\':\'select\',\'options\':[\'管理\',\'专业\',\'操作\',\'辅助\'],\'value\':\'专业\'}],\'提交申请\',\'编制申请已提交\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 新增编制</button>
        <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出编制明细\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>编制明细将导出为 Excel。</p>\',\'确认导出\',\'编制明细已导出\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button>
      </div>
      <table class="data-table">
        ...
        <tbody>
          ${data.details.map(d => {
            ...
            return `<tr><td>${d.id}</td><td><strong>${d.center}</strong></td><td>${d.project}</td><td>${d.position}</td><td>${d.establishment}</td><td>${d.filled}</td><td style="color:var(--info)">${d.recruiting||0}</td><td style="color:${vacant>0?'var(--warning)':'var(--text-light)'}">${vacant>0?vacant:'-'}</td><td>${rate}%</td><td><span class="tag ${status[0]}">${status[1]}</span></td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-bar-chart-2"></use></svg> 编制详情 - \' + rowCellText(this,0),rowDetailHTML(this))">详情</button></td></tr>`;
          }).join('')}
        </tbody>
      </table>
    </div>
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <div class="filter-bar">
        ...
        <button class="btn btn-primary" onclick="showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-plus-circle\"></use></svg> 新增职场','<div style=&quot;padding:20px&quot;><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>职场名称 *</label><input type=&quot;text&quot; id=&quot;wpName&quot; placeholder=&quot;如：太原基地A座&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>所在城市</label><select id=&quot;wpCity&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;><option>太原</option><option>南昌</option><option>晋中</option><option>沈阳</option><option>南宁</option><option>上海</option></select></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>详细地址</label><input type=&quot;text&quot; id=&quot;wpAddr&quot; placeholder=&quot;请输入详细地址&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>面积（㎡）</label><input type=&quot;number&quot; id=&quot;wpArea&quot; placeholder=&quot;0&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;></div><div style=&quot;margin-bottom:14px&quot;><label style=&quot;display:block;font-size:13px;color:#666;margin-bottom:4px&quot;>工位数量</label><input type=&quot;number&quot; id=&quot;wpSeats&quot; placeholder=&quot;0&quot; style=&quot;width:100%;padding:8px 12px;border:1px solid var(--border);border-radius:6px;box-sizing:border-box&quot;></div><button class=&quot;btn btn-primary&quot; style=&quot;width:100%&quot; onclick=&quot;var n=document.getElementById(\\'wpName\\').value;if(!n){alert(\\'请填写职场名称\\');return}closeDetailModal();alert(\\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-check-circle-2"></use></svg> 职场已添加：\\' + n)&quot;>提交</button></div>')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 新增职场</button>
        <button class="btn btn-outline" onclick="showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-download\"></use></svg> 导出职场明细','<div style=&quot;padding:24px;text-align:center&quot;><div style=&quot;font-size:48px;margin-bottom:16px&quot;><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-download\"></use></svg></div><div style=&quot;font-size:16px;font-weight:600;margin-bottom:8px&quot;>导出职场数据</div><div style=&quot;font-size:13px;color:#888;margin-bottom:20px&quot;>当前共有 <strong>X</strong> 个职场记录</div><div style=&quot;display:flex;gap:12px;justify-content:center;margin-bottom:16px&quot;><label style=&quot;flex:1;padding:12px;border:1px solid var(--border);border-radius:8px;cursor:pointer;background:#f8f9ff&quot;><input type=&quot;checkbox&quot; checked style=&quot;margin-right:6px&quot;>含使用率数据</label><label style=&quot;flex:1;padding:12px;border:1px solid var(--border);border-radius:8px;cursor:pointer&quot;><input type=&quot;checkbox&quot; checked>含租金信息</label></div><button class=&quot;btn btn-primary&quot; style=&quot;width:200px&quot; onclick=&quot;closeDetailModal();alert(\\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-check-circle-2"></use></svg> 职场明细已导出\\n\\n文件名：职场明细_20260720.xlsx')确认导出</button></div>')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button>
      </div>
      <table class="data-table">
...
async function loadAdminGift() {
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <div class="filter-bar">
        <button class="btn btn-primary" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 礼品入库\',[{\'name\':\'giftName\',\'label\':\'礼品名称\',\'required\':true},{\'name\':\'giftQty\',\'label\':\'数量\',\'type\':\'number\',\'required\':true,\'value\':\'1\'},{\'name\':\'giftBatch\',\'label\':\'批次\'},{\'name\':\'giftNote\',\'label\':\'备注\',\'type\':\'textarea\',\'rows\':2}],\'登记入库\',\'礼品已入库\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 入库</button>
        <button class="btn btn-outline" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 礼品领用\',[{\'name\':\'giftName\',\'label\':\'礼品\',\'required\':true},{\'name\':\'recvName\',\'label\':\'领用人\',\'required\':true},{\'name\':\'recvDept\',\'label\':\'领用部门\'},{\'name\':\'recvQty\',\'label\':\'数量\',\'type\':\'number\',\'required\':true,\'value\':\'1\'}],\'提交申请\',\'领用申请已提交\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 领用</button>
        <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出礼品明细\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>礼品明细将导出为 Excel。</p>\',\'确认导出\',\'礼品明细已导出\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button>
      </div>
      <table class="data-table">
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <table class="data-table">
        ...
        <tbody>
          ${data.paperStock ? data.paperStock.map(p => `<tr><td><strong>${p.name}</strong></td><td>${p.spec || 'A4'}</td><td>${p.used || 0}包</td><td>${p.stock || 0}包</td><td><span class="tag ${(p.stock||0) < (p.safety||10) ? 'tag-danger':'tag-success'}">${(p.stock||0) < (p.safety||10) ? '补货':'正常'}</span></td><td><button class="btn btn-outline" style="padding:4px 10px;font-size:11px" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-shopping-cart"></use></svg> 申购 - \' + rowCellText(this,1),[{\'name\':\'buyQty\',\'label\':\'采购数量\',\'type\':\'number\',\'required\':true,\'value\':\'1\'},{\'name\':\'buyReason\',\'label\':\'采购事由\',\'type\':\'textarea\',\'required\':true,\'rows\':2}],\'提交申购\',\'采购申请已提交\')">申购</button></td></tr>`).join('') : [
          ...
          ].map((p,i) => `<tr><td><strong>${p.name}</strong></td><td>${p.spec}</td><td>${p.used}包</td><td>${p.stock}包</td><td><span class="tag ${p.stock < p.safety ? 'tag-danger':'tag-success'}">${p.stock < p.safety ? '补货':'正常'}</span></td><td><button class="btn btn-outline" style="padding:4px 10px;font-size:11px" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-shopping-cart"></use></svg> 申购 - \' + rowCellText(this,1),[{\'name\':\'buyQty\',\'label\':\'采购数量\',\'type\':\'number\',\'required\':true,\'value\':\'1\'},{\'name\':\'buyReason\',\'label\':\'采购事由\',\'type\':\'textarea\',\'required\':true,\'rows\':2}],\'提交申购\',\'采购申请已提交\')">申购</button></td></tr>`).join('')}
        </tbody>
      </table>
    </div>
    <div class="chart-card">
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <div class="filter-bar">
        ...
        <button class="btn btn-primary" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-book-open"></use></svg> 新增制度\',[{\'name\':\'regName\',\'label\':\'制度名称\',\'required\':true,\'placeholder\':\'如：考勤管理办法\'},{\'name\':\'regCat\',\'label\':\'分类\',\'type\':\'select\',\'options\':[\'人事\',\'财务\',\'运营\',\'合规\',\'行政\'],\'value\':\'人事\'},{\'name\':\'regContent\',\'label\':\'制度内容\',\'type\':\'textarea\',\'required\':true,\'rows\':4,\'placeholder\':\'请输入制度内容要点\'}],\'发布制度\',\'制度已发布\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 新增制度</button>
        <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出制度清单\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>制度清单将导出为 Excel。</p>\',\'确认导出\',\'制度清单已导出\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button>
      </div>
      <table class="data-table">
        <thead><tr><th>编号</th><th>制度名称</th><th>分类</th><th>发布日期</th><th>修订日期</th><th>版本</th><th>状态</th><th>操作</th></tr></thead>
        <tbody>
          ${data.map(d => `<tr><td>${d.id}</td><td><strong>${d.name}</strong></td><td><span class="tag ${catColors[d.category]||'tag-gray'}">${d.category}</span></td><td>${d.publishDate}</td><td>${d.reviseDate||'-'}</td><td>v${d.version}</td><td><span class="tag ${d.status==='现行'?'tag-success':d.status==='修订中'?'tag-warning':'tag-gray'}">${d.status}</span></td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-book-open"></use></svg> 制度详情 - \' + rowCellText(this,1),rowDetailHTML(this))">查看</button> <button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-arrow-down"></use></svg>️ 下载文档 - \' + rowCellText(this,1),\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>开始下载文档。</p>\',\'开始下载\',\'文档开始下载\')">下载</button></td></tr>`).join('')}
        </tbody>
      </table>
    </div>
  `);
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <div class="filter-bar">
        ...
        <button class="btn btn-primary" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 新增任务\',[{\'name\':\'taskName\',\'label\':\'任务名称\',\'required\':true},{\'name\':\'taskOwner\',\'label\':\'负责人\'},{\'name\':\'taskDue\',\'label\':\'截止日期\',\'type\':\'date\'},{\'name\':\'taskPriority\',\'label\':\'优先级\',\'type\':\'select\',\'options\':[\'高\',\'中\',\'低\'],\'value\':\'中\'}],\'创建任务\',\'任务已创建\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 新增任务</button>
      </div>
      <table class="data-table">
        <thead><tr><th>编号</th><th>任务名称</th><th>负责人</th><th>优先级</th><th>截止日期</th><th>进度</th><th>状态</th><th>操作</th></tr></thead>
        <tbody>
          ${data.map(t => `<tr><td>${t.id}</td><td><strong>${t.name}</strong></td><td>${t.owner}</td><td><span class="tag ${prioColors[t.priority]||'tag-gray'}">${t.priority}</span></td><td>${t.deadline}</td><td><div class="progress" style="width:80px"><div class="progress-bar ${t.progress>=80?'green':t.progress>=40?'orange':'red'}" style="width:${t.progress}%"></div></div> ${t.progress}%</td><td><span class="tag ${statusColors[t.status]||'tag-gray'}">${t.status}</span></td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 任务详情 - \' + rowCellText(this,1),rowDetailHTML(this))">详情</button></td></tr>`).join('')}
        </tbody>
      </table>
    </div>
  `);
      ...
      <table class="data-table">
        ...
        <tbody>
          ${data.map(g => {
            ...
            return `<tr><td>${g.id}</td><td><strong>${g.name}</strong></td><td>${g.owner}</td><td>${g.period}</td><td>${g.target}</td><td>${g.current}</td><td>${rate}%</td><td><div class="progress" style="width:80px"><div class="progress-bar ${rate>=80?'green':rate>=50?'orange':'red'}" style="width:${Math.min(rate,100)}%"></div></div></td><td><span class="tag ${statusColors[g.status]||'tag-gray'}">${g.status}</span></td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-target"></use></svg> 目标详情 - \' + rowCellText(this,1),rowDetailHTML(this))">详情</button></td></tr>`;
          }).join('')}
        </tbody>
      </table>
    </div>
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <div class="filter-bar">
        ...
        <button class="btn btn-outline" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出KPI明细\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>KPI 明细将导出为 Excel。</p>\',\'确认导出\',\'KPI明细已导出\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button>
      </div>
      <table class="data-table">
        ...
        <tbody>
          ${allDetails.map(d => {
            ...
            return `<tr><td>${d.id}</td><td><strong>${d.name}</strong></td><td><span style="font-size:12px">${d.module||'-'}</span></td><td>${d.position||'-'}</td><td>${d.kpi||'-'}</td><td><strong style="font-size:15px;color:${d.score>=90?'var(--success)':d.score>=80?'var(--warning)':'var(--danger)'}">${d.score}</strong></td><td><span class="tag ${grade[0]}">${grade[1]}</span></td><td>${d.rank||'-'}</td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-trend-up"></use></svg> KPI详情 - \' + rowCellText(this,1),rowDetailHTML(this))">详情</button></td></tr>`;
...
async function loadHrProbation() {
  ...
  renderPage(`
    ...
    <div class="chart-card">
      <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 待评估清单 <button class="btn btn-outline" style="float:right;padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出试用期清单\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>试用期评估清单将导出为 Excel。</p>\',\'确认导出\',\'试用期评估清单已导出\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button></div>
      <table class="data-table">
        ...
        <tbody>
          ${data.list.map(r => {
            ...
            return `<tr><td>${r.id}</td><td><strong>${r.name}</strong></td><td>${r.center}</td><td>${r.dept}</td><td>${r.joinDate}</td><td>${r.expireDate}</td><td style="color:${r.daysLeft<0?'var(--danger)':r.daysLeft<=7?'var(--warning)':'var(--text-light)'}"><strong>${r.daysLeft < 0 ? '已超期'+Math.abs(r.daysLeft)+'天' : r.daysLeft+'天'}</strong></td><td><span class="tag ${st[0]}">${st[1]}</span></td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-check-circle-2"></use></svg> 发起转正评估 - \' + rowCellText(this,1),[{\'name\':\'assessScore\',\'label\':\'评估得分\',\'type\':\'number\',\'value\':\'85\'},{\'name\':\'assessComment\',\'label\':\'评估意见\',\'type\':\'textarea\',\'rows\':3}],\'提交评估\',\'转正评估已发起\')">发起评估</button></td></tr>`;
          }).join('')}
        </tbody>
      </table>
    </div>
...
async function loadHrWeekly() {
  ...
  renderPage(`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
      ...
      <div style="display:flex;gap:8px">
        <button class="btn btn-outline" style="padding:5px 14px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出周报\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>周报将导出为 Excel。</p>\',\'确认导出\',\'周报已导出Excel\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出Excel</button>
        <button class="btn btn-primary" style="padding:5px 14px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-mail"></use></svg> 发送周报邮件\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>周报将作为邮件发送至相关接收人。</p>\',\'确认发送\',\'周报邮件已发送\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-mail"></use></svg> 发送邮件</button>
      </div>
    </div>
    <div class="kpi-grid cols-5">
    ...
    <div class="chart-card">
      ...
      <table class="data-table">
        ...
        <tbody>
          ${data.todo.map(t => `<tr><td><span class="tag ${t.tagClass}">${t.type}</span></td><td><strong>${t.item}</strong></td><td>${t.count}</td><td>${t.detail}</td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-file-text"></use></svg> 周报项\',\'<div style=&quot;font-size:13px;line-height:2&quot;>\' + rowCellText(this,0) + \'</div>\')">查看</button></td></tr>`).join('')}
        </tbody>
      </table>
    </div>
  `);
...
async function loadTrainInstructor() {
  ...
  renderPage(`
    ...
    <div class="chart-card">
      <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 讲师明细 <div style="float:right;display:flex;gap:6px"><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-download\"></use></svg> 导入讲师数据','<div style=&quot;padding:24px;text-align:center&quot;><div style=&quot;font-size:48px;margin-bottom:16px&quot;><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-download\"></use></svg></div><div style=&quot;font-size:16px;font-weight:600;margin-bottom:8px&quot;>批量导入讲师信息</div><div style=&quot;font-size:13px;color:#888;margin-bottom:20px&quot;>支持 Excel 格式（.xlsx / .xls）</div><div style=&quot;border:2px dashed var(--border);border-radius:12px;padding:30px;margin-bottom:16px;cursor:pointer&quot; onclick=&quot;alert(\\'请选择Excel文件\\')&quot;><div style=&quot;font-size:32px;margin-bottom:8px&quot;><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-file-text\"></use></svg></div><div style=&quot;color:#888;font-size:13px&quot;>点击选择文件 或 拖拽到此处</div></div><button class=&quot;btn btn-primary&quot; style=&quot;margin-top:12px&quot; onclick=&quot;closeDetailModal();alert(\\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-check-circle-2"></use></svg> 讲师数据导入成功\\n\\n共导入 X 条记录\\n新增 Y 条 / 更新 Z 条\\')">开始导入</button><div style=&quot;margin-top:16px;padding:10px;background:#f0f5ff;border-radius:6px;text-align:left&quot;><div style=&quot;font-size:12px;color:#666;font-weight:600&quot;><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-clipboard-list\"></use></svg> 导入模板字段说明：</div><div style=&quot;font-size:11px;color:#999;line-height:1.8&quot;>工号 | 姓名 | 中心 | 等级 | 专业方向 | 联系电话 | 入职日期</div></div></div>')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导入</button><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showDetailModal('<svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-upload\"></use></svg> 导出讲师明细','<div style=&quot;padding:24px;text-align:center&quot;><div style=&quot;font-size:48px;margin-bottom:16px&quot;><svg class=\"icon-svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><use href=\"#icon-upload\"></use></svg></div><div style=&quot;font-size:16px;font-weight:600;margin-bottom:8px&quot;>导出讲师数据</div><div style=&quot;font-size:13px;color:#888;margin-bottom:20px&quot;>当前共有 <strong>X</strong> 位讲师记录</div><div style=&quot;display:flex;gap:12px;justify-content:center;margin-bottom:16px&quot;><label style=&quot;flex:1;padding:14px;border:1px solid var(--border);border-radius:8px;cursor:pointer;text-align:center;background:#f8f9ff&quot;><input type=&quot;checkbox&quot; checked style=&quot;margin-right:6px&quot;>全量导出</label><label style=&quot;flex:1;padding:14px;border:1px solid var(--border);border-radius:8px;cursor:pointer;text-align:center&quot;><input type=&quot;checkbox&quot;>仅在职讲师</label></div><div style=&quot;display:flex;gap:12px;justify-content:center&quot;><label style=&quot;flex:1;padding:14px;border:1px solid var(--border);border-radius:8px;cursor:pointer;text-align:center&quot;><input type=&quot;checkbox&quot; checked>含评分数据</label><label style=&quot;flex:1;padding:14px;border:1px solid var(--border);border-radius:8px;cursor:pointer;text-align:center&quot;><input type=&quot;checkbox&quot; checked>含授课记录</label></div><button class=&quot;btn btn-primary&quot; style=&quot;margin-top:16px;width:200px&quot; onclick=&quot;closeDetailModal();alert(\\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-check-circle-2"></use></svg> 讲师明细已导出为 Excel\\n\\n文件名：讲师明细_20260720.xlsx\\n记录数：X 条')确认导出</button></div>')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 导出</button></div></div>
      <table class="data-table">
        <thead><tr><th>工号</th><th>姓名</th><th>中心</th><th>等级</th><th>专业方向</th><th>累计授课</th><th>平均评分</th><th>状态</th><th>操作</th></tr></thead>
        <tbody>
          ${data.list.map(r => `<tr><td>${r.id}</td><td><strong>${r.name}</strong></td><td>${r.center}</td><td><span class="tag ${r.level==='五星级'?'tag-warning':r.level==='四星级'?'tag-info':'tag-success'}">${r.level}</span></td><td>${r.expertise}</td><td>${r.courseCount}场</td><td>${r.rating}</td><td>${r.status==='在职'?'<span class="tag tag-success">在职</span>':'<span class="tag tag-danger">离职</span>'}</td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-graduation-cap"></use></svg> 讲师详情 - \' + rowCellText(this,1),rowDetailHTML(this))">详情</button></td></tr>`).join('')}
        </tbody>
      </table>
    </div>
  `);
...
async function loadTrainCourse() {
  ...
  renderPage(`
    ...
    <div class="chart-card">
      <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 课程明细 <div style="float:right;display:flex;gap:6px"><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导入课程\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>请选择课程数据 Excel 文件导入。</p>\',\'选择文件\',\'课程数据导入中\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导入</button><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 导出课程\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>课程明细将导出为 Excel。</p>\',\'确认导出\',\'课程明细已导出\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 导出</button></div></div>
      <table class="data-table">
...
async function loadTrainCadreLoss() {
  ...
  renderPage(`
    ...
    <div class="chart-card">
      <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 干部流失明细 <button class="btn btn-outline" style="float:right;padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出干部流失\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>干部流失明细将导出为 Excel。</p>\',\'确认导出\',\'干部流失明细已导出\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button></div>
      <table class="data-table">
...
async function loadTrainEstLib() {
  ...
  renderPage(`
    ...
    <div class="chart-card">
      <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 编制明细 <div style="float:right;display:flex;gap:6px"><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导入编制数据\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>请选择编制数据 Excel 文件导入。</p>\',\'选择文件\',\'编制数据导入中\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导入</button><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出编制明细\',\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>编制明细将导出为 Excel。</p>\',\'确认导出\',\'编制明细已导出\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 导出</button></div></div>
      <table class="data-table">
...
async function loadTrainMaterial() {
  ...
  renderPage(`
    ...
    <div class="chart-card">
      <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-clipboard-list"></use></svg> 物料库存明细 <button class="btn btn-primary" style="float:right;padding:4px 12px;font-size:12px" onclick="showFormModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 物料入库\',[{\'name\':\'matName\',\'label\':\'物料名称\',\'required\':true},{\'name\':\'matQty\',\'label\':\'数量\',\'type\':\'number\',\'required\':true,\'value\':\'1\'},{\'name\':\'matSupplier\',\'label\':\'供应商\'},{\'name\':\'matNote\',\'label\':\'备注\',\'type\':\'textarea\',\'rows\':2}],\'登记入库\',\'物料已入库\')"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-plus-circle"></use></svg> 入库</button></div>
      <table class="data-table">
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <table class="data-table">
        ...
        <tbody>
          ${data.list.map(p => `<tr><td>${p.id}</td><td><strong>${p.name}</strong></td><td><span class="tag ${p.level==='一级（重大）'?'tag-danger':p.level==='二级（较大）'?'tag-warning':'tag-info'}">${p.level}</span></td><td>${p.category}</td><td>${p.owner}</td><td>${p.lastDrill}</td><td><span class="tag ${p.status==='已发布'?'tag-success':p.status==='演练中'?'tag-warning':'tag-info'}">${p.status}</span></td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-files"></use></svg> 预案详情 - \' + rowCellText(this,1),rowDetailHTML(this))">查看</button></td></tr>`).join('')}
        </tbody>
      </table>
    </div>
    <div class="row cols-2">
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <table class="data-table">
        ...
        <tbody>
          ${data.list.map(p => `<tr><td>${p.id}</td><td><strong>${p.name}</strong></td><td>${p.category}</td><td>${p.publishDate}</td><td>${p.updateDate}</td><td><span class="tag ${p.status==='现行'?'tag-success':p.status==='修订中'?'tag-warning':'tag-info'}">${p.status}</span></td><td>${p.views}</td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-file-text"></use></svg> 文档预览 - \' + rowCellText(this,1),rowDetailHTML(this))">查看</button> <button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-arrow-down"></use></svg>️ 下载文档 - \' + rowCellText(this,1),\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>开始下载文档。</p>\',\'开始下载\',\'文档开始下载\')">下载</button></td></tr>`).join('')}
        </tbody>
      </table>
    </div>
  `);
  ...
  renderPage(`
    ...
    <div class="chart-card">
      ...
      <table class="data-table">
        ...
        <tbody>
          ${data.list.map(m => `<tr><td>${m.id}</td><td><strong>${m.name}</strong></td><td>${m.category}</td><td>${m.scope}</td><td>${m.updateDate}</td><td><span class="tag ${m.status==='现行'?'tag-success':'tag-warning'}">${m.status}</span></td><td>${m.views}</td><td><button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showInfoModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-file-text"></use></svg> 文档预览 - \' + rowCellText(this,1),rowDetailHTML(this))">查看</button> <button class="btn btn-outline" style="padding:4px 12px;font-size:12px" onclick="showConfirmModal(\'<svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-arrow-down"></use></svg>️ 下载文档 - \' + rowCellText(this,1),\'<p style=&quot;margin:0;color:#666;font-size:13px&quot;>开始下载文档。</p>\',\'开始下载\',\'文档开始下载\')">下载</button></td></tr>`).join('')}
        </tbody>
      </table>
    </div>
  `);
...
function renderToolbar() {
  ...
  tb.innerHTML = `
    ...
    <div class="tb-right">
      <button class="btn btn-outline btn-sm" onclick="doExport()"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-download"></use></svg> 导出</button>
      <button class="btn btn-primary btn-sm" onclick="doImport()"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-upload"></use></svg> 导入</button>
    </div>`;
}
