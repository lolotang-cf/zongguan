...
async function loadRecruitAchievement() {
  ...
  renderPage(`
    ...
    <div class="row cols-2">
      ...
      <div class="chart-card">
        <div class="chart-title"><svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-users"></use></svg> 集招达成</div>
